...
- **2026-07-25/26 — the A2 line: adaptivity, monitor gating, and persistent heterogeneity.** Six
  ...
  `tools/dispersion-ebh-boundary.ts` (+ `tools/dispersion-monitor.ts` runtime gate; tests, 65 total).
