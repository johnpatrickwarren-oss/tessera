# NEXT-ROLE — Tessera (Phase 4 shard, R73–R87 directives + all routing blocks)

_This file is a frozen historical shard of `coordination/NEXT-ROLE.md`. Active file: `coordination/NEXT-ROLE.md`. Cross-phase reference: see active-file phase-shard index._

_Frozen at R89 sharding (2026-05-21). Do NOT append; new routing blocks belong in active NEXT-ROLE.md._

_Scope: R73–R87 directives + all routing blocks (all rounds prior to R88). Phase 3 directives (R42–R72) are included in this shard for structural simplicity — no clean phase break existed in NEXT-ROLE.md prior to R89; see § 0 Decision 1 in Q-R89-SPEC.md._

_Original line-number back-references refer to line numbers in the pre-R89 NEXT-ROLE.md at SHA `db232d9`. Lines 127–7961 from that file. To resolve a prior-round directive or routing block, read this shard starting from the matching `## §` or `## STATUS:` heading._
