# Project state history (frozen)

**Frozen:** 2026-08-24 (was root `STATE.md`; last substantive update 2026-06-28) · **by:** John Warren (with Claude)

> **Current status — date · suite pass/skip · what's built · what's next — lives in `HANDOFF.md`, the SINGLE
> SOURCE OF TRUTH.** This file is the frozen point-in-time decision/arc history through 2026-06-28; it is not
> updated. Decisions since then are recorded in `decisions/` (ADRs) and HANDOFF.md. The per-entry
