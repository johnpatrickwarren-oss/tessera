...
- **AC-9** Whitened AR(1) null FPR verdict is `PASS` (not significantly above alpha) for all
  rho <= 0.9 at the tool's default alpha and window count; the rho=0.95 near-unit-root residual is
  reported, not hidden (honest measurement — see AC-12).
