# SPEC — Phase-2 intervention campaign on the mac mini

- **Date:** 2026-07-27 (drafted and SIGNED OFF same day)
- **Status:** **SIGNED OFF — § 5's asks resolved by the owner, 2026-07-27:** lowpower events
  approved (root, machine-wide); pacing approved (≤ 3 events/day, ~3 weeks, 1-in-3 days A/A);
...
## 5. Owner sign-off — RESOLVED 2026-07-27 (decisions in the header)
