...
// adapters/topology/neuron-source.ts in @johnpatrickwarren-oss/deploysignal-engine v0.7.0-pre, and Tessera-original before
// the R90 extract). Tessera owns this file; the engine copy is deleted at its next major.
// anchor:allow require-tests: covered by test/q53-neuron-adapter.test.ts
