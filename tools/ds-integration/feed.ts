...
// adapters/ds-integration/feed.ts in @johnpatrickwarren-oss/deploysignal-engine v0.7.0-pre, and Tessera-original before
...
import type { VerdictGroup } from '@johnpatrickwarren-oss/deploysignal-engine/types/verdict';
import {
