...
// adapters/ds-integration/event-contract.ts in @johnpatrickwarren-oss/deploysignal-engine v0.7.0-pre, and Tessera-original before
// the R90 extract). Tessera owns this file; the engine copy is deleted at its next major.
// anchor:allow require-tests: covered by test/q66-ds-integration-event-consumer.test.ts and test/q62-ds-integration-contract.test.ts
