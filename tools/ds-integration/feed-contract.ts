...
// adapters/ds-integration/feed-contract.ts in @johnpatrickwarren-oss/deploysignal-engine v0.7.0-pre, and Tessera-original before
// the R90 extract). Tessera owns this file; the engine copy is deleted at its next major.
// anchor:allow require-tests: covered by test/q65-ds-integration-feed.test.ts
...
// VerdictGroup. The projection does NOT import from '@johnpatrickwarren-oss/deploysignal-engine/types' to preserve
